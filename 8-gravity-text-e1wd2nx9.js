...
// pages/demos/examples/gravity-text.ts
...
var colors = ["#ff6b6b", "#ffd93d", "#6bcb77", "#4d96ff", "#cc5de8", "#ff922b", "#20c997", "#a855f7", "#38bdf8", "#fb923c"];
var sizes = [16, 20, 24, 28, 32, 40];
await document.fonts.ready;
var fallingWords = [];
var groundedRects = [];
var spawnTimer = 0;
function measureWord(text, font, fontSize) {
