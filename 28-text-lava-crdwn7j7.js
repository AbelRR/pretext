...
// pages/demos/examples/text-lava.ts
...
var blobColors = ["#ff6b6b", "#cc5de8", "#4d96ff", "#20c997", "#ff922b", "#6bcb77", "#f472b6", "#a78bfa"];
var font = "14px 'Helvetica Neue', Helvetica, Arial, sans-serif";
var lineHeight = 20;
await document.fonts.ready;
var prepared = blobTexts.map((t) => prepareWithSegments(t, font));
var blobs = blobTexts.map((_, i) => ({
...
function draw() {
  ...
  for (const b of blobs) {
    ...
    const gradient = ctx.createRadialGradient(b.x + blobWidth / 2, b.y + blobHeight / 2, 0, b.x + blobWidth / 2, b.y + blobHeight / 2, Math.max(blobWidth, blobHeight));
