...
// pages/demos/examples/text-sorting.ts
...
var texts = [
  ...
  "Can you review?",
  "The CI pipeline is failing on arm64 builds again",
  ...
  "WebSocket connections per tab are expensive",
  "Let's pair tomorrow",
  "The quarterly report is due by Friday",
  "Bug fix deployed ✅",
  "Performance looks good in prod",
  "Schema migration complete",
  "API rate limits increased to 1000/min",
  "New feature flag enabled",
  "Hotfix for the auth middleware",
  ...
  "Unit test coverage at 87%",
  "Staging environment restored",
  "Production deploy scheduled",
  "Incident postmortem written"
];
var font = "13px 'Helvetica Neue', Helvetica, Arial, sans-serif";
var lineHeight = 18;
var colors = ["#ff6b6b", "#ffd93d", "#6bcb77", "#4d96ff", "#cc5de8", "#ff922b", "#20c997", "#38bdf8", "#f472b6", "#a78bfa"];
