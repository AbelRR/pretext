...
// pages/demos/examples/concrete-poetry.ts
...
var font = "15px 'Georgia', 'Times New Roman', serif";
var lineHeight = 21;
var colors = ["#a78bfa", "#818cf8", "#6366f1", "#7c3aed", "#8b5cf6"];
await document.fonts.ready;
var prepared = prepareWithSegments(poem, font);
var currentShape = "circle";
function getWidthForLine(shape, lineIndex, totalLines, maxWidth) {
  ...
  switch (shape) {
    ...
    case "heart": {
      const y = 1 - t * 2;
      if (y > 0.6) {
        const w2 = Math.sqrt(1 - (y - 0.3) * (y - 0.3) * 4) * maxWidth * 0.9;
        return Math.max(20, w2);
      }
...
function getXOffset(shape, lineIndex, totalLines, lineWidth, maxWidth) {
