...
// pages/demos/examples/ransom-note.ts
...
var fonts = ["Georgia", "Courier New", "Times New Roman", "Arial", "Helvetica Neue", "Impact"];
var bgColors = ["#fef3c7", "#fce7f3", "#d1fae5", "#dbeafe", "#ede9fe", "#fee2e2", "#ffedd5", "#e0e7ff"];
var textColors = ["#92400e", "#9d174d", "#065f46", "#1e40af", "#5b21b6", "#991b1b", "#9a3412", "#3730a3"];
