...
// pages/demos/examples/canvas-text-rendering.ts
var texts = [
  {
    label: "English",
...
var prepared = texts.map((t) => prepareWithSegments(t.text, font));
var preparedFast = texts.map((t) => prepare(t.text, font));
function renderAll(containerWidth) {
