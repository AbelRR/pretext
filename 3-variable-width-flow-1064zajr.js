...
ctx.scale(dpr, dpr);
var obstacle = { x: 60, y: 40, size: 160 };
function render() {
  ...
  while (true) {
    ...
    if (line === null)
      break;
    ctx.fillText(line.text, lineX, y + 17);
    cursor = line.end;
    y += lineHeight;
    if (y > 500)
      break;
...
function setupSlider(id, prop, valId) {
