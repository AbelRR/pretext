...
// pages/demos/examples/resize-perf-benchmark.ts
var sampleTexts = [
...
var lineHeight = 22;
var widths = [250, 300, 350, 400, 450];
await document.fonts.ready;
var statusEl = document.getElementById("status");
var resultsEl = document.getElementById("results");
statusEl.textContent = "Preparing texts...";
var prepareStart = performance.now();
var prepared = texts.map((t) => prepare(t, font));
var prepareTime = performance.now() - prepareStart;
var hiddenBench = document.getElementById("hidden-bench");
var domItems = texts.map((t) => {
...
function showResults(pretextResult, domResult) {
  let html = "";
  if (pretextResult) {
    html += `
